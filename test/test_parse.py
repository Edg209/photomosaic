...
class TestParse(TestCase):
    ...
    def test_folder_already_exists(self, mocked_open, mocked_mkdir):
    ...
    def test_missing_target_image(self, mocked_open, mocked_mkdir):
    ...
    def test_missing_candidate_image_folder(self, mocked_open, mocked_mkdir):
    ...
    def test_invalid_grid_shape(self, mocked_open, mocked_mkdir):
    ...
    def test_invalid_output_shape(self, mocked_open, mocked_mkdir):
    ...
    def test_invalid_comparison_shape(self, mocked_open, mocked_mkdir):

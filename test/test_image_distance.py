...
import numpy as np
from photomosaic.image_distance.image_distance import image_distance, CandidateImageDistanceGrid
...
class TestImageDistance(TestCase):
    ...
    def test_different_shapes(self):
        ...
        with pytest.raises(InvalidShapeException):
            image_distance(self.img_3x4_ffffff, self.img_4x3_000000)
    ...
    def test_incorrect_dtype(self):
        ...
        with pytest.raises(InvalidTypeException):
            image_distance(self.img_3x4_ffffff, changed_type)

    def test_white_vs_black(self):
        """Test that a plain white and plain black image have the maximum distance"""
        distance = image_distance(self.img_3x4_ffffff, self.img_3x4_000000)
    ...
    def test_alternating_stripe(self):
        ...
        distance = image_distance(self.img_3x4_white_stripe, self.img_3x4_black_stripe)
        assert distance == pytest.approx(255)
    ...
    def test_white_stripe(self):
        ...
        distance = image_distance(self.img_3x4_white_stripe, self.img_3x4_000000)
    ...
    def test_complex_vs_bw(self):
        ...
        distance = image_distance(self.img_3x4_black_stripe, self.img_3x4_123456)
    ...
    def test_complex_vs_complex(self):
        ...
        distance = image_distance(self.img_3x4_123456, self.img_3x4_d29c55)
